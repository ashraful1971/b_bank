...
<div class="bg-sky-600 pb-32">
    <!-- Navigation -->
    <nav class="border-b border-sky-300 border-opacity-25" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
                            ...
                            <!-- Current: "bg-sky-700 text-white", Default: "text-white hover:bg-sky-500 hover:bg-opacity-75" -->
                             <?php
                                $getMenuItemClasses = function($route){
                                    return request()->getRoutePath() == $route ? "bg-sky-700 text-white rounded-md py-2 px-3 text-sm font-medium" : "text-white hover:bg-sky-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium";
                                }
                             ?>
                            <a href="<?php __(url('/admin/customers')) ?>" class="<?php echo $getMenuItemClasses('/admin/customers')?>">Customers</a>
                            <a href="<?php __(url('/admin/transactions')) ?>" class="<?php echo $getMenuItemClasses('/admin/transactions')?>">Transactions</a>
                        </div>
                    </div>
                </div>
        ...
        <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
            <div class="space-y-1 pt-2 pb-3">
                <a href="<?php __(url('/admin/customers')) ?>" class="text-white hover:bg-sky-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Customers</a>

                <a href="<?php __(url('/admin/transactions')) ?>" class="text-white hover:bg-sky-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Transactions</a>
            </div>
            <div class="border-t border-sky-700 pb-3 pt-4">
                ...
                <div class="mt-3 space-y-1 px-2">
                    <a href="<?php __(url('/logout')) ?>" class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-sky-500 hover:bg-opacity-75">Sign out</a>
                </div>
            </div>
        </div>
    </nav>
