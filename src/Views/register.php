    ...
    <div class="flex flex-col justify-center min-h-full py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
            <div class="px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12">
                ...
                <form class="space-y-6" action="<?php __(url('/register')) ?>" method="POST">
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="first_name" name="first_name" type="text" required="" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6 p-2">
                        </div>
                    </div>
                    <div>
                        <label for="last_name" class="block text-sm font-medium leading-6 text-gray-900">Last Name</label>
                        <div class="mt-2">
                            <input id="last_name" name="last_name" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6 p-2">
                        </div>
                    </div>
                    <div>
            ...
            <p class="mt-10 text-sm text-center text-gray-500">
                Already a customer?
                <a href="<?php __(url('/login')) ?>" class="font-semibold leading-6 text-emerald-600 hover:text-emerald-500">Sign-in</a>
            </p>
        </div>
    </div>
</section>
